    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-6 bg-zinc-950 text-white font-sans">
      <div className="w-full max-w-md p-8 space-y-8 bg-zinc-900/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-zinc-800/50">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-zinc-400">Create an account to begin your journey.</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          ...
          {error && (
            <div className={`p-3 text-sm rounded-lg flex items-center gap-2 ${error.includes('successful') ? 'bg-green-950/30 border border-green-900/50 text-green-400' : 'bg-red-950/30 border border-red-900/50 text-red-400'}`}>
